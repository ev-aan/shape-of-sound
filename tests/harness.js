...
const THREE={AdditiveBlending:2,
 ...
 PointsMaterial:class{},CanvasTexture:class{},SphereGeometry:class{dispose(){}},ConeGeometry:class{dispose(){}},
...
const cache={};
global.document={getElementById:id=>cache[id]||(cache[id]=el()),createElement:()=>el(),querySelectorAll:()=>[],querySelector:()=>el(),__h:{},addEventListener(t,f){(this.__h[t]=this.__h[t]||[]).push(f);}};
