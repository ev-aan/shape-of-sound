...
// Purely structural — draws the ring and (optionally) a caption strip, then hands taps to whoever
// asked for them via opts.onSelect. Each consumer decides what a tap means: the Simple front door
// highlights fifths-neighbours, Musical mode sets a key. Nothing is shared/global, so two mounted
// instances never fight over the same caption element.
